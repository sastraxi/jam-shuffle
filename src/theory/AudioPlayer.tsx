...
class AudioPlayer extends Component {
	...
	playCurStrings() {
		this.midiSounds.playChordAt(this.midiSounds.contextTime() + 0.15 * 0, this.state.selectedInstrument, [S6], 1.5);
		this.midiSounds.playChordAt(this.midiSounds.contextTime() + 0.15 * 1, this.state.selectedInstrument, [S5], 1.3);
		this.midiSounds.playChordAt(this.midiSounds.contextTime() + 0.15 * 2, this.state.selectedInstrument, [S4], 1.2);
		this.midiSounds.playChordAt(this.midiSounds.contextTime() + 0.15 * 3, this.state.selectedInstrument, [S3], 1.1);
		this.midiSounds.playChordAt(this.midiSounds.contextTime() + 0.15 * 4, this.state.selectedInstrument, [S2], 1.1);
		this.midiSounds.playChordAt(this.midiSounds.contextTime() + 0.15 * 5, this.state.selectedInstrument, [S1], 1.0);
